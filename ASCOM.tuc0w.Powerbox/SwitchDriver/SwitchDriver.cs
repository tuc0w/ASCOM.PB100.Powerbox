...
namespace ASCOM.PB100.Switch
{
    ...
    //
    // Your driver's DeviceID is ASCOM.PB100.Switch
    //
    // The COM Guid attribute sets the CLSID for ASCOM.PB100.Switch
    // The COM ClassInterface/None attribute prevents an empty interface called _PB100 from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("abf26628-26dc-484d-b1b5-a205f29c5407")]
    [ProgId("ASCOM.PB100.Switch")]
    [ServedClassName("ASCOM Switch Driver for PB100")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Switch : ReferenceCountedObjectBase, ISwitchV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PB100"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Switch()
        {
            try
            {
                ...
                tl = new TraceLogger("", "PB100.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.PB100.Switch", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
