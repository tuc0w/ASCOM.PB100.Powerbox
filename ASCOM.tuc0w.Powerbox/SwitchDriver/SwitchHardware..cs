...
//
// ASCOM Switch hardware class for PB100
//
    ...
    internal static class SwitchHardware
    {
        ...
        static SwitchHardware()
        {
            try
            {
                ...
                tl = new TraceLogger("", "PB100.Hardware");
        ...
        public static string Name
        {
            ...
            get
            {
                string name = "Powerbox PB100 ASCOM";
        ...
        internal static bool GetSwitch(short id)
        {
            ...
            lock (_lock)
            {
                ...
                return response == $"P{realSwitch}:1";
            }
        }
        ...
        internal static void SetSwitch(short id, bool state)
        {
            ...
            if (response != "OK")
            {
                LogMessage("SetSwitch", $"SetSwitch({id}) - Error setting switch");
                throw new ASCOM.DriverException($"SetSwitch({id}) - Error setting switch");
            }
        }
